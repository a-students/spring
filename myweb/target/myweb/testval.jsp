...
<div class="container center">
    <form class="form-horizontal col-lg-offset-2" role="form" method="post" id="Myform" action="#">
        ...
        <div class="form-group">
            <label class="control-label col-lg-2" for="Mycode">验证码:</label>
            <div class="col-lg-3">
                <div class="input-group">
               <span class="input-group-addon">
                   <i class="glyphicon glyphicon-envelope"></i>
        ...
        <div class="form-group">
            <label class="control-label col-lg-2" for="Mypassword2">重复密码:</label>
            <div class="col-lg-4">
                <div class="input-group ">
                <span class="input-group-addon">
                    <i class="glyphicon glyphicon-lock"></i>
        ...
        <div class="form-group">
            <label class="control-label col-lg-2" for="Myname">昵称:</label>
            <div class="col-lg-4">
                <div class="input-group ">
                <span class="input-group-addon">
                <i class="glyphicon glyphicon-user"></i>
